...
/*
* This program is used for dense mapping.
* input：Real time reconstruction module saves prior information sfm.txt and keyframe images
...
//#define use_custom_pose
	...
	if ((ARCHIVE_TYPE)OPT::nArchiveType != ARCHIVE_MVS) {
		...
		if (!scene.DenseReconstruction(OPT::nFusionMode)) { //OPT::nFusionMode=0
			//未进入，但运行了scene.DenseReconstruction(OPT::nFusionMode)
